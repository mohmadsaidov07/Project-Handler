...
# from models import Project, CreateProject, UpdateProject
...
# def create_project(project: CreateProject, project_id=None) -> CreateProject:
#     conn = connect_sql()
#     cursor = conn.cursor()
